...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  return array.find(e => e === elemento) !== undefined
}
...
function mesesDelAño(array) {
  ...
  if (meses.find(m => m === "Enero") === undefined
    || meses.find(m => m === "Marzo") === undefined
    || meses.find(m => m === "Noviembre") === undefined) {
